...
const parentCategories: ParentCategory[] = [
  { id: 'chicken', name: 'चिकन', icon: '🍗', subCategories: [{ id: 'Chicken', name: 'चिकन' }] },
  { id: 'chicken shawarma', name: 'चिकन शावरमा', icon: '🌯', subCategories: [{ id: 'Chicken Shawarma', name: 'चिकन शावरमा' }] },
  { id: 'mutton', name: 'मटन', icon: '🍖', subCategories: [{ id: 'Mutton', name: 'मटन' }] },
  { id: 'biryani', name: 'बिरयानी', icon: '🍚', subCategories: [{ id: 'Biryani', name: 'बिरयानी' }] },
  { id: 'momos', name: 'मोमोज़', icon: '🥟', subCategories: [{ id: 'Momos', name: 'मोमोज़' }] },
];
  ...
  useEffect(() => {
    async function loadMenuItems() {
      ...
      const formatted: MenuItem[] = items
        .filter((item: any) => (item.language || '').toLowerCase() === 'hindi')
        .map((item: any) => ({
